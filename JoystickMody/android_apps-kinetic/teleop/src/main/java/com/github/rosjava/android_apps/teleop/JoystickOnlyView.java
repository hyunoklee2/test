 ...
 */
public class JoystickOnlyView extends RelativeLayout implements AnimationListener {
  ...
  public JoystickOnlyView(Context context, AttributeSet attrs) {
    super(context, attrs);
    initVirtualJoystick(context);
    mContext = context;
  }

  public JoystickOnlyView(Context context, AttributeSet attrs, int defStyle) {
  ...
  private void publishVelocity(double linearVelocityX, double linearVelocityY,
    ...
    currentVelocityLinear[0] = linearVelocityX;
    currentVelocityLinear[1] = -linearVelocityY;
    currentVelocityLinear[2] = 0;
    currentVelocityAgular[0] = 0;
    currentVelocityAgular[1] = 0;
    currentVelocityAgular[2] = -angularVelocityZ;
  }
