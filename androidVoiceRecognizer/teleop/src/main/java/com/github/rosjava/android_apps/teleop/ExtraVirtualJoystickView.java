 ...
 */
public class ExtraVirtualJoystickView extends RelativeLayout implements AnimationListener,
  ...
  private Publisher<std_msgs.String> extrapublisher;
  private Publisher<std_msgs.String> voicepublisher;
  private ConnectedNode gconnectedNode ;
  /**
  ...
  private geometry_msgs.Twist currentVoiceVelocityCommand;
  private std_msgs.String currentExtraCommand;
  private std_msgs.String currentVoiceCommand;
  private String topicName;
  private String extratopicName;
  private String voicetopicName;
  private Boolean voiceConrol = false ;

  public ExtraVirtualJoystickView(Context context) {
    super(context);
    initVirtualJoystick(context);
    topicName = "~cmd_vel";
    extratopicName = "~cmd_extra";
    voicetopicName = "~recognizer/output";
    voiceConrol = false ;
  }

  public ExtraVirtualJoystickView(Context context, AttributeSet attrs) {
    super(context, attrs);
    initVirtualJoystick(context);
    topicName = "~cmd_vel";
    extratopicName = "~cmd_extra";
  ...
  public ExtraVirtualJoystickView(Context context, AttributeSet attrs, int defStyle) {
  ...
  public void setVoiceConrol(boolean enabled) {
    voiceConrol = enabled;
  }
  ...
  private void initVirtualJoystick(Context context) {
    ...
    mainLayout = (RelativeLayout) findViewById(org.ros.android.android_15.R.id.virtual_joystick_layout);
    magnitudeText = (TextView) findViewById(org.ros.android.android_15.R.id.magnitude);
    intensity = (ImageView) findViewById(org.ros.android.android_15.R.id.intensity);
    thumbDivet = (ImageView) findViewById(org.ros.android.android_15.R.id.thumb_divet);
    orientationWidget = new ImageView[24];
    orientationWidget[0] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_0_degrees);
    orientationWidget[1] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_15_degrees);
    orientationWidget[2] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_30_degrees);
    orientationWidget[3] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_45_degrees);
    orientationWidget[4] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_60_degrees);
    orientationWidget[5] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_75_degrees);
    orientationWidget[6] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_90_degrees);
    orientationWidget[7] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_105_degrees);
    orientationWidget[8] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_120_degrees);
    orientationWidget[9] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_135_degrees);
    orientationWidget[10] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_150_degrees);
    orientationWidget[11] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_165_degrees);
    orientationWidget[12] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_180_degrees);
    orientationWidget[13] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_195_degrees);
    orientationWidget[14] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_210_degrees);
    orientationWidget[15] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_225_degrees);
    orientationWidget[16] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_240_degrees);
    orientationWidget[17] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_255_degrees);
    orientationWidget[18] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_270_degrees);
    orientationWidget[19] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_285_degrees);
    orientationWidget[20] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_300_degrees);
    orientationWidget[21] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_315_degrees);
    orientationWidget[22] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_330_degrees);
    orientationWidget[23] = (ImageView) findViewById(org.ros.android.android_15.R.id.widget_345_degrees);
    ...
    currentRotationRange = (ImageView) findViewById(org.ros.android.android_15.R.id.top_angle_slice);
    previousRotationRange = (ImageView) findViewById(org.ros.android.android_15.R.id.mid_angle_slice);
    // Hide the slices/arcs used during the turn-in-place mode.
    currentRotationRange.setAlpha(0.0f);
    previousRotationRange.setAlpha(0.0f);
    lastVelocityDivet = (ImageView) findViewById(org.ros.android.android_15.R.id.previous_velocity_divet);
  ...
  public void publishVoiceVelocity(double linearVelocityX, double linearVelocityY,
                               double angularVelocityZ) {
    currentVoiceVelocityCommand.getLinear().setX(linearVelocityX);
    currentVoiceVelocityCommand.getLinear().setY(-linearVelocityY);
    currentVoiceVelocityCommand.getLinear().setZ(0);
    currentVoiceVelocityCommand.getAngular().setX(0);
    currentVoiceVelocityCommand.getAngular().setY(0);
    currentVoiceVelocityCommand.getAngular().setZ(-angularVelocityZ);
  }
  ...
  public void setTopicName(String topicName,String extratopicName, String voicetopicName ) {
    this.topicName = topicName;
    this.extratopicName = extratopicName;
    this.voicetopicName = voicetopicName;
  }

  public void setExtraTopicName(String extratopicName_) {

    if( extratopicName.equals(extratopicName_)){

    }else{
      this.extratopicName = extratopicName_;
      extrapublisher.shutdown();
      extrapublisher = gconnectedNode.newPublisher(extratopicName, std_msgs.String._TYPE);
    }
  }

  public void setExtraPublish(String extratopicCommand) {
    currentExtraCommand.setData(extratopicCommand);
    extrapublisher.publish(currentExtraCommand);
  }

  public void setVoicePublish(String voiceCommand) {
    currentVoiceCommand.setData(voiceCommand);
    voicepublisher.publish(currentVoiceCommand);
  }
  ...
  public void onStart(ConnectedNode connectedNode) {
    gconnectedNode = connectedNode ;
    publisher = connectedNode.newPublisher(topicName, geometry_msgs.Twist._TYPE);
    extrapublisher = connectedNode.newPublisher(extratopicName, std_msgs.String._TYPE);
    voicepublisher = connectedNode.newPublisher(voicetopicName, std_msgs.String._TYPE);
    currentVelocityCommand = publisher.newMessage();
    currentVoiceVelocityCommand = publisher.newMessage();
    currentExtraCommand = extrapublisher.newMessage();
    currentVoiceCommand = voicepublisher.newMessage();
      ...
      public void run() {
        if(!voiceConrol) {
          if (publishVelocity) {
            ...
            publisher.publish(currentVoiceVelocityCommand);
        }
      }
    }, 0, 80);
  }
