...
public class RosTextView2<T> extends TextView implements NodeMain {

  private String topicName;
  private String messageType;
  private MessageCallable<String, T> callable;

  public RosTextView2(Context context) {
    super(context);
  }

  public RosTextView2(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public RosTextView2(Context context, AttributeSet attrs, int defStyle) {
